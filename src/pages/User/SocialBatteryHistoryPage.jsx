  ...
  return (
    <div className="min-h-screen space-y-6  p-4 text-[#1E3557] dark:bg-slate-950 dark:from-slate-950 dark:via-slate-950 dark:to-slate-900 dark:text-slate-100 md:p-6">
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[#061B3A] dark:text-white">
            Social Battery History
          </h1>

          <p className="text-[#5D6B82] dark:text-slate-300">
        ...
        <Link
          ...
          className="w-fit rounded-full bg-[#0A4774] px-4 py-2 text-sm font-semibold text-white shadow-[0_4px_10px_rgba(10,71,116,0.25)] hover:bg-[#0E5A92] dark:bg-blue-600 dark:hover:bg-blue-500"
        >
